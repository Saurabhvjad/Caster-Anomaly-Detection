...
def main():
    ...
    with st.container():
        ...
        # Accumulate alerts during play (total + per-rule)
        ...
        with m5:
            st.metric("▶ Session Alerts", st.session_state.play_total_alerts)
            st.markdown(
                f'<div style="font-size:0.7rem;margin-top:-0.5rem;color:#555;">'
